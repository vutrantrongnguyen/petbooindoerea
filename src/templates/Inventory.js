    ...
    return (
      <>
        ...
        <div>
          <h3>Inventory</h3>
          <div className="flex">
            <p role="button" className="mr-4 cursor-pointer hover:text-secondary"
               onClick={() => this.toggleViewState("view")}>View</p>
            <p role="button" className="cursor-pointer hover:text-secondary"
               onClick={() => this.toggleViewState("add")}>Add</p>
          </div>
          {
